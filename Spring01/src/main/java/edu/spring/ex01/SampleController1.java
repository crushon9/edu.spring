...
import org.slf4j.Logger; // Logger 패키지가 많으니 주의
...
@Controller // @Controller 어노테이션을 쓰면 서블릿 상속받은것처럼 클래스에 적용됨
...
public class SampleController1 {
	...
	// value = URL 경로
	// method = 요청 방식 설정(GET/POST/PUT/DELETE), 속성 생략하면 GET/POST 모두 처리 가능
	// short cut 기능 : @GetMapping, @PostMapping, ...
	public String sample1() {
		logger.info("sample1() 호출");
		return "sample1"; // jsp 경로 및 이름
		// WEB-INF/views/sample1.jsp 로 찾아감 (servlet-context.xml에 설정되어 있음)
	...
	public void sample2() {
		// 리턴 문자열이 없으면 url value 이름에 맞는 jsp를 찾아서 적용
